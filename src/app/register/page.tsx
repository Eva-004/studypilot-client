...
import { FiCommand, FiMail, FiLock, FiUser, FiArrowRight } from "react-icons/fi";
    ...
    <main className="min-h-screen bg-[#F8F9FA] flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-[#6C757D]">
          Or{" "}
          <Link href="/login" className="font-semibold text-[#4F46E5] hover:text-[#3B32C4] transition-colors">
      ...
      >
        <div className="bg-white py-8 px-4 shadow-sm border border-[#E9ECEF] sm:rounded-2xl sm:px-10">
          <form className="space-y-5" onSubmit={handleSubmit}>
            <div>
              <label htmlFor="name" className="block text-xs font-bold uppercase tracking-wider text-[#495057]">
                Full Name
              </label>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase tracking-wider">
                <span className="px-3 bg-white text-[#6C757D] font-medium">Or register with</span>
              </div>
            </div>
